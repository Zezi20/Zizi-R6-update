...
export default function CartsidebarRowSix() { // Corrected closing parenthesis
  return (
      ...
      <div className="container-xs mb-[18px] flex justify-center md:px-5">
        <div className="flex w-full flex-col gap-9">
          <div className="mx-[106px] flex flex-col gap-9 md:mx-0">
            ...
            <div className="flex flex-col gap-[30px]">
              <Heading as="p" className="text-justify text-[16px] font-normal leading-6 text-gray-500">
                ...
                unmistakable look and sound of Marshall, unplugs the cords, and takes the show on the road.
              </Heading>
              <Heading as="p" className="text-justify text-[16px] font-normal leading-6 text-gray-500">
          ...
          <div className="flex gap-7 md:flex-col">
            ...
            <CloudSofaImage sofaImage="images/img_cloud_sofa_three_296x604.png" className="rounded-[10px] bg-deep_orange-50" />
          </div>
        </div>
      </div>
    </div>
